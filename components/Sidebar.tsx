...
export default function Sidebar() {
  ...
  return (
    <aside
      className="no-print flex h-screen w-64 flex-shrink-0 flex-col border-r backdrop-blur-xl"
    ...
    >
      <div className="flex items-center gap-3 px-6 py-6">
        ...
        <div>
          <p className="font-display text-sm font-bold tracking-wide" style={{ color: 'var(--color-text)' }}>
            VOLGA
          </p>
          <p className="text-[10px]" style={{ color: 'var(--color-input-placeholder)' }}>
            Elevators ERP
          </p>
        </div>
      </div>
      ...
      <div className="border-t p-4" style={{ borderColor: 'var(--color-glass-border)' }}>
        <div
        ...
        >
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-[10px] capitalize" style={{ color: 'var(--color-input-placeholder)' }}>
              {profile?.role}
            </p>
          </div>
        </div>
    ...
    <Link
      ...
      className={clsx(
        ...
        active
          ...
          : 'hover:bg-mint-500/5 border-transparent'
      )}
      style={!active ? { color: 'var(--color-muted-text)' } : undefined}
    >
      {icon}
